    ...
    render() {
        ...
        return (
            <div>
                ...
                <Swiper {...params}>
                    <div class = "hobby">
                        <img src={require("../../images/modelun.png")} alt="munlogo" width="100%" height="80%" class="CenteredHover" border = "3 px solid" />
                        <div class="overlay">
                        <h1 class="hobbytext"> Here is model Un </h1>
                        </div>
                    </div>
                    <div class = "hobby" >
                        <img src={require("../../images/robotics.jpg")} alt="munlogo" width="100%" height="80%" class="CenteredHover" border = "3 px solid" />
                        <div class="overlay">
                    ...
                    <div class = "hobby" >
                        <img src={require("../../images/robotics.jpg")} alt="munlogo" width="100%" height="80%" class="CenteredHover" />
                        <div class="overlay">
